...
export default function CampaignEmpty() {
  return (
    <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 flex flex-col items-center justify-center text-center transition-all hover:border-[#0A2328] hover:bg-white/50 cursor-pointer min-h-[280px]">
